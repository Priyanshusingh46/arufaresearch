...
const polar_params_1 = require("../core/params/polar-params");
const project_structure_1 = require("../core/project-structure");
const runtime_env_1 = require("../core/runtime-env");
...
const log = (0, debug_1.default)("polar:core:cli");
...
async function gatherArguments() {
    ...
    const envVariableArguments = (0, env_variables_1.getEnvRuntimeArgs)(polar_params_1.POLAR_PARAM_DEFINITIONS, process.env);
    const argumentsParser = new arguments_parser_1.ArgumentsParser();
    const { runtimeArgs, taskName: maybeTaskName, unparsedCLAs } = argumentsParser.parseRuntimeArgs(polar_params_1.POLAR_PARAM_DEFINITIONS, polar_params_1.POLAR_SHORT_PARAM_SUBSTITUTIONS, envVariableArguments, process.argv.slice(2));
...
async function loadEnvironmentAndArgs(maybeTaskName, runtimeArgs, argumentsParser, unparsedCLAs) {
    ...
    const env = new runtime_env_1.Environment(config, runtimeArgs, taskDefinitions, envExtenders, !isSetup);
...
async function main() {
    ...
    try {
        ...
        if (errors_1.PolarError.isPolarError(error)) {
            console.error(chalk_1.default.red(`Error ${error.message}`));
        }
        else if (errors_1.PolarPluginError.isPolarPluginError(error)) {
