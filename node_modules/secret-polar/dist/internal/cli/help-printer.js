...
class HelpPrinter {
    constructor(_programName, _version, _paramDefs, _tasks) {
    ...
    printGlobalHelp(includeInternalTasks = false) {
        ...
        for (const name of Object.keys(tasksToShow).sort(strings_1.cmpStr)) {
    ...
    _getParamsList(paramDefinitions) {
        let paramsList = "";
        for (const name of Object.keys(paramDefinitions).sort(strings_1.cmpStr)) {
    ...
    _printParamDetails(paramDefinitions) {
        ...
        const paramsNameLength = paramKeys
            ...
            .reduce(getMax, 0);
        for (const name of paramKeys.sort(strings_1.cmpStr)) {
