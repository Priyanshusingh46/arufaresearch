...
export declare class TasksDSL {
     ...
     * @returns A task definition.
     */
    internalTask<ArgsT extends TaskArguments>(name: string, description?: string, action?: ActionType<ArgsT>): TaskDefinition;
    /**
     ...
     * @returns A task definition.
     */
    internalTask<ArgsT extends TaskArguments>(name: string, action: ActionType<ArgsT>): TaskDefinition;
    /**
