    ...
    fromJSON(object) {
        return {
            max_tokens: isSet(object.max_tokens)
                ? coin_1.Coin.fromJSON(object.max_tokens)
                : undefined,
            allow_list: isSet(object.allow_list)
                ? exports.StakeAuthorization_Validators.fromJSON(object.allow_list)
                : undefined,
            deny_list: isSet(object.deny_list)
                ? exports.StakeAuthorization_Validators.fromJSON(object.deny_list)
                : undefined,
